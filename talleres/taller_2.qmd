...
Crear un histograma de las alturas de una clase de estudiantes:

```{pyodide-python}
import matplotlib.pyplot as plt

# Datos de altura de los estudiantes en centímetros
alturas = [150, 160, 165, 170, 155, 180, 175, 160, 165, 170]

# Crear el histograma
plt.hist(alturas, bins=5, edgecolor='black')
