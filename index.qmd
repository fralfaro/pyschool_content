...
data = {
    ...
    "Término": ["9:30", "10:15", "11:30", "13:00", "1:30"],
...
**Taller 1:** Común para todos los participantes: [Introducción a Python](./talleres/taller_1.html).

**Taller 2:** Opcional, según la elección de cada participante:

- [Python en Ciencias](./talleres/taller_2.html)
- [Python en Ciencia de Datos](./talleres/taller_3.qmd.html)
